...
"""
DBI-MambaUNet uses the nnU-Net v2 data layout. By default, data is read from
<repo>/data, but existing nnU-Net users can keep their own paths by setting
...
base = os.path.abspath(join(os.path.dirname(__file__), os.pardir, 'data'))
