...
class nnUNetTrainerDBIMambaUNet_FocalTversky_Loss(nnUNetTrainer):
    @staticmethod
...
globals()["nnUNetTrainerDBI-MambaUNet_FocalTversky_Loss"] = nnUNetTrainerDBIMambaUNet_FocalTversky_Loss
