...
class nnUNetTrainerDBIMambaUNet_CE_Tversky_Loss(nnUNetTrainer):
    @staticmethod
...
globals()["nnUNetTrainerDBI-MambaUNet_CE_Tversky_Loss"] = nnUNetTrainerDBIMambaUNet_CE_Tversky_Loss
globals()["nnUNetTrainerDBI-MambaUNet_Tversky_CE_Loss"] = nnUNetTrainerDBIMambaUNet_CE_Tversky_Loss
