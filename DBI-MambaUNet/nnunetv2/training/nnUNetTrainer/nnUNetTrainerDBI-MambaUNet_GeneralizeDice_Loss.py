...
class nnUNetTrainerDBIMambaUNet_GeneralizedDice_Loss(nnUNetTrainer):
    @staticmethod
    ...
    def _build_loss(self):
        loss = GeneralizedDiceLoss(
            ...
            smooth=1e-5,
            ddp=self.is_ddp,
            vol_power=2.0,  # 對應 Sudre 論文的 GDLv 權重
        )
...
globals()["nnUNetTrainerDBI-MambaUNet_GeneralizedDice_Loss"] = nnUNetTrainerDBIMambaUNet_GeneralizedDice_Loss
globals()["nnUNetTrainerDBI-MambaUNet_GeneralizeDice_Loss"] = nnUNetTrainerDBIMambaUNet_GeneralizedDice_Loss
