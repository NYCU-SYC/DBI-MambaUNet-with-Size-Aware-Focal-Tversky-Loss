...
class nnUNetTrainerDBIMambaUNet_CE_FocalTversky_Loss(nnUNetTrainer):
    @staticmethod
...
globals()["nnUNetTrainerDBI-MambaUNet_CE_FocalTversky_Loss"] = nnUNetTrainerDBIMambaUNet_CE_FocalTversky_Loss
globals()["nnUNetTrainerDBI-MambaUNet_FocalTversky_CE_Loss"] = nnUNetTrainerDBIMambaUNet_CE_FocalTversky_Loss
