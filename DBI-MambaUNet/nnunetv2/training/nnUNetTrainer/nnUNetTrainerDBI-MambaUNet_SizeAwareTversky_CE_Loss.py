...
class nnUNetTrainerDBIMambaUNet_SizeAwareTversky_CE_Loss(nnUNetTrainer):
    @staticmethod
...
globals()["nnUNetTrainerDBI-MambaUNet_SizeAwareTversky_CE_Loss"] = nnUNetTrainerDBIMambaUNet_SizeAwareTversky_CE_Loss
