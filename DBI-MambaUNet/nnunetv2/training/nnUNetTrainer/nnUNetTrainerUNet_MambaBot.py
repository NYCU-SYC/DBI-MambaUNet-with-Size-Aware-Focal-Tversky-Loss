...
from nnunetv2.nets.UNet_MambaBot import get_unet_mamba_bot_3d_from_plans


class nnUNetTrainerUNet_MambaBot(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        if len(configuration_manager.patch_size) == 2:
            ...
            model = get_unet_mamba_bot_3d_from_plans(plans_manager, dataset_json, configuration_manager,
                                                 num_input_channels, deep_supervision=enable_deep_supervision)
        else:
